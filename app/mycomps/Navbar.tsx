...
{darkMode && <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setdarkMode(false)} fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 mt-3">
