        ...
        <div className={darkMode?(isOpen?"dark  overflow-hidden relative h-screen bg-black  text-white":"dark bg-black relative text-white"):(isOpen?"overflow-hidden h-screen relative":"")}>
            ...
            {/* <Navbar darkMode={darkMode} setdarkMode={setDarkMode}  /> */}
                ...
                <p className="mb-2">For example:</p>
                    ...
                    <p className="mb-2">Has your asset risen by 2 pips beyond the predetermined criteria, or 1? If you predict a sharp change in the asset&apos;s movement during the trade&apos;s time frame then trading a CFD might be your better option. However, there are risks involved, and the potential losses should also be examined.</p>
